...
public class ImageEncoder 
{
	...
	public static void main(String []a) throws Exception
	{
		...
		File in_f=new File("C:\\work\\IIITD\\Monsoon 2012\\Foundation of Computer Security (CSE 545)\\Assignments\\3\\Stegno_col\\secret message.jpg");
		//change location for the temporary file storage, later to be deleted. file name is strictly bin.txt
		File bin_f=new File("C:\\work\\IIITD\\Monsoon 2012\\Foundation of Computer Security (CSE 545)\\Assignments\\3\\Stegno_col\\bin.txt");
		bin_f.createNewFile();
